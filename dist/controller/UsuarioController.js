...
const UsuarioUpdateDto_1 = require("../model/dto/UsuarioUpdateDto");
...
let UsuarioController = class UsuarioController extends tsoa_1.Controller {
    ...
    async ListarUsuarios(fail, success) {
        try {
            ...
            return success(200, new BasicResponseDto_1.BasicResponseDto("Usuarios cadastrados no sistema listado com sucesso", usuarioDto));
        }
        catch (err) {
            return fail(500, new BasicResponseDto_1.BasicResponseDto("Erro ao listar usuarios " + err.message, undefined));
        }
    }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, UsuarioUpdateDto_1.UsuarioUpdateDto, Function, Function]),
    __metadata("design:returntype", Promise)
